        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                <img src="images/profile/<?php echo $profile;?>" alt="profile"/>
            </a>
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
			...
			<?php 
				...
				$q1 = $conn->query("SELECT * FROM `enable_history` WHERE `enable_history_section` = '$student_section' AND `enable_history_fac`='$section_adviser_s_id'") or die(msqli_error());
				$f1 = $q1->fetch_array();

				$q2 = $conn->query("SELECT * FROM `enable_history_lab` WHERE `enable_history_sec` = '$student_section' AND `enable_history_fac`='$section_adviser_s_id' ") or die(msqli_error());
				$f2 = $q2->fetch_array();

                $week_lec = $f1['enable_history_id'];
                $week_lab = $f2['enable_history_id'];

                $q3 = $conn->query("SELECT * FROM `laboratories` WHERE `lab_id` = '$week_lab' ") or die(msqli_error());
                $f3 = $q3->fetch_array();

                $q4 = $conn->query("SELECT * FROM `weeks` WHERE `weeks_id` = '$week_lec' ") or die(msqli_error());
                $f4 = $q4->fetch_array();
			?>
                ...
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card bg-gradient-info">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo $f4['weeks_name']?> is now Active</p>
                        <p><br></p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                  <div class="card bg-gradient-primary">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo $f3['lab_title']?> is Now Active</p>
                        <p><br></p>
                    </div>
                  </div>
                </div>
