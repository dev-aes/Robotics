    ...
    <div class="container-fluid page-body-wrapper">
     ...
     <!-- partial -->
      <div class="main-panel">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0"> 
                  ...
                  <h6 class="font-weight-normal mb-0">This is the Section List </h6>
                </div>
              </div>
            </div>
          </div>	
        ...
        <tbody><?php 
					$q_e = $conn->query("SELECT * FROM `section` ") or die(mysqli_error());
					while($f_e=$q_e->fetch_array()){ 
				?>
            <tr>
                <td style="text-transform:capitalize;"><?php echo $f_e['section_name']?></td>
                <td style="text-transform:capitalize;"><?php if($f_e['section_status']==0){ echo "No Adviser Yet"; }else{ echo "Occupied"; } ?></td>
            </tr>	
				<?php
					}
				?>
