...
<body onload="myFunction()">
 ...
 <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background:#ef4747;">
      ...
      <div class="main-panel">
        ...
        <tbody><?php 
					$q_e = $conn->query("SELECT * FROM `student_file` WHERE `student_lab_num`='1'") or die(mysqli_error());
            ...
            <tr>
                ...
                <td>
                    <?php if(!empty($f_e['student_lab_date'])){ ?>
                        <a href="view-update.php?student_file_id=<?php echo $f_e['student_file_id']?>&section_name=<?php echo $_GET['section_name']?>&student_lab_num=1" class="btn bg-danger btn-sm">Update</a>
                    <?php }else{
                        ?>
