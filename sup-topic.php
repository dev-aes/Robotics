        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin">
                ...
                $q_e = $conn->query("SELECT * FROM `supplementary` WHERE `id`='$id' AND `sec_id`='$section_id'") or die(mysqli_error());
                $f_e = $q_e->fetch_array();
                ?>
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold" style="text-transform:capitalize;">Welcome <?php echo $f['fname'];?></h3>
                  <h6 class="font-weight-normal mb-0">This is the topic for <span class="text-primary"><b><?php echo $f_e['topic_name']?></b></span></h6>
                </div>
              </div>
            </div>
          </div>	
		  ...
		  <!-- Content Left -->
            <div class="col-md-6 grid-margin transparent">
                  ...
                  <div class="card">
                    <div class="card-body">
					<!-- Content Left Title -->
                      <h4 class="card-title"><?php echo $f_e['topic_name']?></h4>
                        <?php echo $f_e['topic_content']?>
                    </div>
                  </div>
            </div>
			<!-- Content Right -->
            <div class="col-md-6 grid-margin transparent">
                <?php
                if(file_exists('faculty/video/sup/'.$f_e['video_name'])){?>
                    <div class="card">
                        <div class="card-body">
                            <p class="card-description">
                            <center>
                                <video id="someID" width="100%" height="480" controls onseeking="myFunction(this.currentTime)">
                                    <source src="faculty/video/sup/<?php echo $f_e['video_name']?>"></video>
                            </center>
                            </p>
                        </div>
                    </div><br>
