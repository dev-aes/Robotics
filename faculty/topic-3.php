        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin">
                ...
                if($count1>='1'){
                    ?>
                    <a href="topic-3.php?disabled=1&week_num=<?php echo $_GET['week_num']?>&section_id=<?php echo $_GET['section_id']?>" class="btn btn-primary btn-sm" >Disable this Week</a>
                <?php }else{
                    ?>
                    <a href="topic-3.php?disabled=0&week_num=<?php echo $_GET['week_num']?>&section_id=<?php echo $_GET['section_id']?>" class="btn btn-primary btn-sm" >Enable this Week</a>
                    <?php
                }
              ...
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0">This is the topic for <span class="text-primary"><b>Week 3 - Encoders</b></span></h6>
                </div>
              </div>
            </div>
          </div>	
		  ...
		  <!-- Content Left -->
            <div class="col-md-6 grid-margin transparent">
                  ...
                  <div class="card">
                    <div class="card-body">
					<!-- Content Left Title -->
                      <h4 class="card-title">Encoders</h4>
                      <p>
					<!-- Content Left Description -->
                        <b>What is Encoder?</b><br>
                          Encoders are mechanical to electrical transducers whose output is derived by “reading” a coded pattern on a rotating disk or a moving scale. Encoders are classified by the
                          <ul>
                            <li> Method used to read the coded element: contact or non-contact</li>
                            <li>type of output: absolute digital word or series of incremental pulses</li>
                            <li>physical phenomenon employed to produce the output: electrical conduction, magnetic, optical, capacitive</li>
                          </ul>
                        <p>There are 2 types of Encoder: <b>Contact</b> and <b>Non-contact</b> Encoders</p>
                      </p>
					<!-- Content Left Dark Description -->
                      <p>
						<b>Contact Encoders</b><br>
                          Contact encoders are those which employ mechanical contact between a brush or pin sensor and the coded disk.
                          The disk contains a series of concentric rings or tracks which are thin metallic strips joined at their base as shown in figure 1. The four tracks shown in figure 1 represent a binary code consisting of 2<sup>0</sup>, 2<sup>1</sup>, 2<sup>2</sup>, 2<sup>3</sup>.
                          The associated contact sensors are identified at B<sub>0</sub>, B<sub>1</sub>, B<sub>2</sub>, B<sub>3</sub>, and encode the numerals 0 through 15. As the disk rotates, the sensors alternately contact conductive strips and adjacent insulators, producing a series of square wave patterns.<br>
                          <center><img src="images/img-2.jpg" style="width: 70%; "></center><br>
                          <center><b>Figure 1:</b> Contact Encoder</center><br>
                      </p>
                      <p>
                          <b>Non-Contact Encoders</b><br>
                          Non-contact encoders are those which employ physical phenomena other than electrical conduction to read the coded disc. The most common types are magnetic, capacitive, and optical<br><br>
                          <center><img src="images/img-3.png" style="width: 40%; "> <img src="images/img-4.png" style="width: 30%; "> <img src="images/img-5.jpg" style="width: 27%; "></center><br>
                          <center><b>Figure 2:</b> Non-Contact Encoders: magnetic(left), capacitive(center), optical(right)</center><br>
                        <p>The video on the left shows some more information about this topic, and how to implement this onto the simulator, Autodesk TinkerCAD. You can also download the full lecture in PDF form right below of the video.</p>
					  </p>
                    </div>
                  </div>
            </div>
				...
				<div class="card">
                    <div class="card-body">
                        ...
                        <center>
                            ...
                            <source src="video/topic-2.mp4" type="video/mp4"></video>
                        </center>
                        </p>
                    </div>
                </div><br>
                <div class="card">
                    <div class="card-body">
                        ...
                        <center> <!-- Content 2 Right PDF -->
                            <a href="pdf/Topic-2.pdf" target="_blank">View this PDF</a><br><br>
                            <b>Reference: </b>https://www.e-ika.com/downloads/DC%20motor%20with%20encoder%20manual%20(1.1%20W).pdf3.
                        </center>
                        </p>
                    </div>
                </div>
