        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin">
                ...
                if($count1>='1'){
                    ?>
                    <a href="topic-10.php?disabled=1&week_num=<?php echo $_GET['week_num']?>&section_id=<?php echo $_GET['section_id']?>" class="btn btn-primary btn-sm" >Disable this Week</a>
                <?php }else{
                    ?>
                    <a href="topic-10.php?disabled=0&week_num=<?php echo $_GET['week_num']?>&section_id=<?php echo $_GET['section_id']?>" class="btn btn-primary btn-sm" >Enable this Week</a>
                    <?php
                }
