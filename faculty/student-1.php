     ...
     <!-- partial -->
      <div class="main-panel">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0"> 
                  ...
                  <h6 class="font-weight-normal mb-0">This is the Your Student List </h6>
                </div>
              </div>
            </div>
          </div>	
        ...
        <tbody><?php 
					...
					$q_e = $conn->query("SELECT * FROM `user_account` WHERE `position`='Student' AND `student_section`='$section_name' AND `status_2`!='Decline'") or die(mysqli_error());
            ...
            <tr>
                ...
                <td><?php echo $f['section_name'];?></td>
                <td><?php echo $f_e['user_id_number'];?></td>
                <td><?php echo $f_e['status_1'];?></td>
                <td>
				<?php 
				if($f_e['status_2']!='For Approval'){
					echo $f_e['status_2'];
				}else{
				?>
					<a class="btn btn-block btn-info btn-lg font-weight-medium auth-form-btn" href="student-1.php?section_name=<?php echo $_GET['section_name'];?>&student_status=<?php echo $f_e['u_id'];?>&action=Accept">Accept</a>
					<a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="student-1.php?section_name=<?php echo $_GET['section_name'];?>&student_status=<?php echo $f_e['u_id'];?>&action=Decline">Decline</a>
				<?php }?>	
				</td>
                <td>
                    <a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="student-1.php?section_name=<?php echo $_GET['section_name'];?>&student_id=<?php echo $f_e['u_id'];?>&action2=Delete">Delete</a>
                </td>
            </tr>	
				<?php
					}
					if(isset($_GET['student_status'])){
						...
						$action 		= $_GET['action'];
						$section_name 		= $_GET['section_name'];
						$result1=$conn->query("UPDATE `user_account` SET `status_2`='$action' WHERE `u_id`='$student_status'");
						if ($result1) {
									echo '<script>
									function myFunction() {
										swal({
										...
										window.location = "student-1.php?section_name='.$section_name.'";
									  });}
								  </script>';			
						}else{
							echo '<script>
                    ...
                    $result2 = $conn->query("DELETE FROM user_account WHERE u_id='$student_id'");
                    if ($result2) {
                            echo '<script>
									function myFunction() {
										swal({
