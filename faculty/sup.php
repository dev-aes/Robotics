            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0"> 
                  ...
                  <h6 class="font-weight-normal mb-0">This is the Supplementary Topics</h6>
                </div>
              </div>
            </div>
          </div>	
          ...
          <div class="row">
			...
			?>
                <div class="col-md-3 mb-4 stretch-card transparent">
				  ...
				  <a href="supplementary.php?section_name=<?php echo $f1['section_id']?>" style="text-decoration:none;">
                    <div class="card-body">
