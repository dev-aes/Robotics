        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin">
                ...
                $sql1="SELECT count(*) AS total1 FROM `enable_history_lab` WHERE `enable_history_id` = '1' AND `enable_history_fac`='$u_id' AND `enable_history_sec`='$section_name'";
                ...
                if($count1>='1'){
                ?>
                <a href="lab-lec.php?disabled=1&week=1&section_name=<?php echo $_GET['section_name']?>&disable" class="btn btn-primary btn-sm" >Disable this Week</a>
                <?php }else{
                ?>
                <a href="lab-lec.php?disabled=0&week=1&section_name=<?php echo $_GET['section_name']?>&disable" class="btn btn-primary btn-sm" >Enable this Week</a>
                <?php
                }
                if(isset($_GET['disabled'])){
                    ...
                    $section_name	 =$_GET['section_name'];
                    if($disabled==1){
                        $result=$conn->query("DELETE FROM `enable_history_lab` WHERE `enable_history_id`='$week' AND `enable_history_fac`='$u_id' AND `enable_history_sec`='$section_name'");
                        if($result){
                            echo
                                '<script>
					            function myFunction(){
						            ...
						            window.location = "lab-lec.php?section_name='.$section_name.'";
					                });}
				                </script>';
                        }else{
                            echo'
                        ...
                        $sql ="INSERT INTO enable_history_lab VALUES(null,'$week','$u_id','$section_name')";
                ...
                ?>
                <a href="lab.php" class="btn btn-primary btn-sm" >Go Back</a><br><br>
              <div class="row">
                  ...
                  <div class="card">
					...
					<!-- Content Left Description -->
                        <b>What is TinkerCAD?</b><br>
                          ...
                          Tinkercad Circuits is the easiest way to get the students started with learning electronics.
                          Using interactive circuit editor, students can explore, connect, and code virtual projects with a bottomless toolbox of simulated components.<br>
                      </p>
