        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin transparent">
              <div class="row">
                  <?php
                  $q_e = $conn->query("SELECT * FROM `weeks` ") or die(mysqli_error());
                  while($f_e=$q_e->fetch_array()){
                      ?>
                      <div class="col-md-3 mb-4 stretch-card transparent">
                          <div class="card card-light-danger">
                              <a href="lecture-1.php?week_num=<?php echo $f_e['weeks_id']?>" style="text-decoration:none;">
                                  <div class="card-body">
                                      <p class="mb-4">Lecture</p>
                                      <p class="fs-30 mb-2"><?php echo $f_e['weeks_name']?></p>
                                      <p>&nbsp;</p>
                                  </div>
                              </a>
                          </div>
