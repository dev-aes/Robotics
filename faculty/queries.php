            ...
            <div class="content-wrapper">
                ...
                <div class="row" >
                    <div class="col-md-12">
                        ...
                        <div class="card card-prirary cardutline direct-chat direct-chat-primary" >
                            ...
                            <div class="card-body" >
                                <div class="direct-chat-messages fix" id="message-content" style="height:200px;">
                                    ...
                                    $q_e = $conn->query("SELECT * FROM `chat` WHERE `chat_to`='$u_id' AND `chat_user`='$id_faculty' ORDER BY `chat_time` ASC") or die(mysqli_error());
                                    while($f_e=$q_e->fetch_array()){
                                        ...
                                        $result=$conn->query("UPDATE `chat` SET `view`='1'  WHERE `chat_user_id` = '$id_faculty' AND `chat_user` = '$id_faculty' AND `chat_to`='$u_id' AND `view`=''");
                                        if($result){}
						...
						<?php echo $f1['fname']." ".$f1['mname']." ".$f1['lname']?></b></span>
                                                    <span class="direct-chat-timestamp" style="font-size:10px;"><?php echo $chat_time?></span>
                                                </div>
                                                <span  class="direct-chat-img" style="font-size:40px;"></span>
                                                <div class="direct-chat-text"><?php echo $chat_message?></div>
                                            </div>
                                            <?php
                                        }
                                    }
                      ...
                      <button type="submit" name="send" class="btn btn-primary">Send</button>
                                ...
                                if(isset($_POST['send'])){
                                    ...
                                    $sql1 ="INSERT INTO chat VALUES(null,'$faculty_id','1','$u_id1','$message','$transdate','$u_id1','')";
