          ...
          <div class="row">
		    ...
		    <form class="pt-3"method = "POST" action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype = "multipart/form-data" autocomplete="off">
                ...
                <div class="form-group row">
					...
					<input type="email" class="form-control form-control-lg" name="email" placeholder="Enter Email Address" id="email2" value="<?php echo $f['email']?>" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,63}$" title="Hey, you are missing domain part in the email !!!">
