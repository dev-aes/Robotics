        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin">
                ...
                if($count1>='1'){
                    ?>
                    <a href="topic-8.php?disabled=1&week_num=<?php echo $_GET['week_num']?>&section_id=<?php echo $_GET['section_id']?>" class="btn btn-primary btn-sm" >Disable this Week</a>
                <?php }else{
                    ?>
                    <a href="topic-8.php?disabled=0&week_num=<?php echo $_GET['week_num']?>&section_id=<?php echo $_GET['section_id']?>" class="btn btn-primary btn-sm" >Enable this Week</a>
                    <?php
                }
              ...
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0">This is the topic for <span class="text-primary"><b>Week 8 - Ultrasonic Sensor</b></span></h6>
                </div>
              </div>
            </div>
          </div>	
		  ...
		  <!-- Content Left -->
            <div class="col-md-6 grid-margin transparent">
                  ...
                  <div class="card">
                    <div class="card-body">
					<!-- Content Left Title -->
                      <h4 class="card-title">Ultrasonic Sensor</h4>
                      <p>
					<!-- Content Left Description -->
                        <b>What is ultrasonic sensor?</b><br>
                          Ultrasonic sensors work by emitting sound waves at a frequency which is too high for humans to hear.
                          In industrial applications, an ultrasonic detection used to detect hidden tracks, discontinuities in metals, composites, plastics, ceramics, and for water level detection.
                          For this purpose, the laws of physics which are indicating the propagation of sound waves through solid materials have been used since ultrasonic sensors using sound instead of light for detection.<br>
                        <center><img src="images/img-14.jpg" style="width: 50%; "></center><br>
                      </p>
					<!-- Content Left Dark Description -->
                      <p>
                          An above image shows the HC-SR-04 ultrasonic sensor which has transmitter, receiver. The pin configuration is,
                          <ul>
                            <li><b>VCC</b> - +5V supply</li>
                            <li><b>TRIG</b> - Trigger input of sensor. Microcontroller applies 10 us trigger pulse to the HC-SR04 ultrasonic module.</li>
                            <li><b>ECHO</b> - Echo output of sensor. Microcontroller reads/monitors this pin to detect the obstacle or to find the distance.</li>
				...
				<div class="card">
                    <div class="card-body">
                        ...
                        <center>
                            ...
                            <source src="video/topic-7.mp4" type="video/mp4"></video>
                        </center>
                        </p>
                    </div>
                </div><br>
                <div class="card">
                    <div class="card-body">
                        ...
                        <center> <!-- Content 2 Right PDF -->
                            <a href="pdf/Topic-7.pdf" target="_blank">View this PDF</a>
                        </center>
                        </p>
                    </div>
                </div>
