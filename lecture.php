          ...
          <div class="row">
            <div class="col-md-12 grid-margin transparent">
              <div class="row">
                  ...
                  $q_e = $conn->query("SELECT * FROM `weeks` Order by `weeks_name`='ASC'") or die(mysqli_error());
                  while($f_e=$q_e->fetch_array()){
                      //PARA SA MULTIPLE ACCOUNT YUNG $student_section is ma kikita dun sa line 118
                      //then yung sa features ng faculty nasa topic.php na file line 234 may explain din ako dun
                      $weeks_id = $f_e['weeks_id'];
                      $weeks_status = $f_e['weeks_status'];
                      $qc = $conn->query("SELECT * FROM `section_adviser` WHERE `section_adviser_u_id` = '$student_section'") or die(msqli_error());
                      $fc = $qc->fetch_array();
                      $adviser = $fc['section_adviser_s_id'];
                      $sqlc="SELECT count(*) AS totalc FROM `enable_history` WHERE `enable_history_fac` = '$adviser' AND `enable_history_id`='$weeks_id' AND `enable_history_section`='$student_section'";
                      $resultc=mysqli_query($conn,$sqlc);
                      $datac=mysqli_fetch_assoc($resultc);
                      ...
                      if($datac['totalc']>=1){
                          ...
                          <div class="col-md-3 mb-4 stretch-card transparent">
                              <div class="card card-light-danger">
                                  <a href="topic-<?php echo $f_e['weeks_id']?>.php" style="text-decoration:none;">
                                      <div class="card-body">
                                          <p class="mb-4" style="color:white;">Lecture</p>
                                          <p class="fs-30 mb-2" style="color:white;"><?php echo $f_e['weeks_name']?></p>
