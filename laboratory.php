        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin transparent">
              <div class="row">
                    <?php
                    $q_e = $conn->query("SELECT * FROM `laboratories` Order by `lab_title`='ASC'") or die(mysqli_error());
                    while($f_e=$q_e->fetch_array()){
                        $lab_id = $f_e['lab_id'];
                        ...
                        $sqlc="SELECT count(*) AS totalc FROM `enable_history_lab` WHERE `enable_history_fac` = '$adviser' AND `enable_history_id`='$lab_id'";
                        $resultc=mysqli_query($conn,$sqlc);
                        $datac=mysqli_fetch_assoc($resultc);
                        ...
                        <div class="col-md-3 mb-4 stretch-card transparent">
                            <div class="card card-light-danger">
                                <a href="lab-<?php echo $f_e['lab_id']?>.php" style="text-decoration:none;">
                                    <div class="card-body">
                                        <p class="mb-4" style="color:white;">Laboratory</p>
                                        <p class="fs-30 mb-2" style="color:white;"><?php echo $f_e['lab_title']?></p>
