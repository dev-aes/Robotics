                  ...
                  while($f_e1=$q_e1->fetch_array()){
                      ...
                      <div class="col-md-3 mb-4 stretch-card transparent">
                          <div class="card card-light-danger">
                              <a href="sup-topic.php?id=<?php echo $f_e1['id']?>&section_id=<?php echo $section_id?>" style="text-decoration:none;">
                                  <div class="card-body">
                                      <p class="mb-4">Supplementary</p>
                                      <p class="fs-30 mb-2"><?php echo $f_e1['topic_name']?></p>
                                  </div>
                              </a>
                          </div>
                      </div>
